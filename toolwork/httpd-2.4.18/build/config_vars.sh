...
if test -f ${DESTDIR}/home/apache/binwork/apr_1_5_2/bin/apr-1-config; then
   APR_CONFIG=${DESTDIR}/home/apache/binwork/apr_1_5_2/bin/apr-1-config
   APU_CONFIG=${DESTDIR}/home/apache/binwork/apr_util_1_5_4/bin/apu-1-config
else
...
test -n "/home/apache/binwork/apr_util_1_5_4/bin/apu-1-config" && APU_INCLUDEDIR="`${APU_CONFIG} --includedir`"

installbuilddir="/home/apache/binwork/httpd_2_4_18/build"
